...
const _forTrack0 = ($index, $item) => $item.id ?? $item.tourId ?? $index;
function HomeToursList_Conditional_9_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function HomeToursList_Conditional_9_Template_button_click_4_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.loadTours()); });
    i0.ɵɵtext(5);
...
function HomeToursList_Conditional_10_For_2_Template(rf, ctx) { if (rf & 1) {
...
function HomeToursList_Conditional_10_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 7);
    i0.ɵɵrepeaterCreate(1, HomeToursList_Conditional_10_For_2_Template, 6, 0, "div", 11, i0.ɵɵrepeaterTrackByIdentity);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    i0.ɵɵadvance();
    i0.ɵɵrepeater(i0.ɵɵpureFunction0(0, _c0));
} }
function HomeToursList_Conditional_11_For_2_Conditional_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span", 22);
    i0.ɵɵelement(1, "i", 32);
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const tour_r3 = i0.ɵɵnextContext().$implicit;
    const ctx_r1 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r1.destinationName(tour_r3));
} }
function HomeToursList_Conditional_11_For_2_Conditional_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const tour_r3 = i0.ɵɵnextContext().$implicit;
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(tour_r3.subDescription ?? tour_r3.description);
} }
function HomeToursList_Conditional_11_For_2_Conditional_10_Template(rf, ctx) { if (rf & 1) {
...
function HomeToursList_Conditional_11_For_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "a", 17)(1, "article", 19)(2, "div", 20);
    i0.ɵɵelement(3, "img", 21);
    i0.ɵɵconditionalCreate(4, HomeToursList_Conditional_11_For_2_Conditional_4_Template, 3, 1, "span", 22);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "div", 23)(6, "h2", 24);
    i0.ɵɵtext(7);
    i0.ɵɵelementEnd();
    i0.ɵɵconditionalCreate(8, HomeToursList_Conditional_11_For_2_Conditional_8_Template, 2, 1, "p", 25);
    i0.ɵɵelementStart(9, "div", 26);
    i0.ɵɵconditionalCreate(10, HomeToursList_Conditional_11_For_2_Conditional_10_Template, 4, 4, "p", 27);
    ...
    const ctx_r1 = i0.ɵɵnextContext(2);
    i0.ɵɵproperty("routerLink", i0.ɵɵpureFunction1(11, _c1, tour_r3.id ?? tour_r3.tourId));
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("src", ctx_r1.imageUrl(tour_r3), i0.ɵɵsanitizeUrl)("alt", ctx_r1.tourTitle(tour_r3));
    i0.ɵɵadvance();
    i0.ɵɵconditional(ctx_r1.destinationName(tour_r3) ? 4 : -1);
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate(ctx_r1.tourTitle(tour_r3));
    i0.ɵɵadvance();
    i0.ɵɵconditional(tour_r3.subDescription ?? tour_r3.description ? 8 : -1);
    i0.ɵɵadvance(2);
    i0.ɵɵconditional((tmp_17_0 = ctx_r1.durationDays(tour_r3)) ? 10 : -1, tmp_17_0);
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate(ctx_r1.formattedPrice(tour_r3));
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", i0.ɵɵpipeBind1(16, 9, "exploreNow"), " ");
} }
function HomeToursList_Conditional_11_ForEmpty_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(4, 1, "noToursFound"));
} }
function HomeToursList_Conditional_11_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 8);
    i0.ɵɵrepeaterCreate(1, HomeToursList_Conditional_11_For_2_Template, 18, 13, "a", 17, _forTrack0, false, HomeToursList_Conditional_11_ForEmpty_3_Template, 5, 3, "div", 18);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
...
function HomeToursList_Conditional_12_For_11_Template(rf, ctx) { if (rf & 1) {
...
function HomeToursList_Conditional_12_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("change", function HomeToursList_Conditional_12_Template_select_change_9_listener($event) { i0.ɵɵrestoreView(_r4); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.onPageSizeChange($event)); });
    i0.ɵɵrepeaterCreate(10, HomeToursList_Conditional_12_For_11_Template, 2, 2, "option", 40, i0.ɵɵrepeaterTrackByIdentity);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(12, "app-pagination-one", 41);
    i0.ɵɵlistener("pageChange", function HomeToursList_Conditional_12_Template_app_pagination_one_pageChange_12_listener($event) { i0.ɵɵrestoreView(_r4); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.onPageChange($event)); });
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance(2);
...
export class HomeToursList {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: HomeToursList, selectors: [["app-home-tours-list"]], decls: 14, vars: 8, consts: [[1, "relative", "table", "w-full", "bg-cover", "bg-center", "bg-no-repeat", "py-36"], [1, "absolute", "inset-0", "bg-gradient-to-b", "from-slate-900/55", "via-slate-900/75", "to-slate-900"], [1, "container", "relative", "pt-10", "text-center"], [1, "text-4xl", "font-semibold", "tracking-wide", "text-white"], [1, "relative", "py-16", "md:py-24"], [1, "container", "relative"], [1, "mb-6", "flex", "flex-wrap", "items-center", "justify-between", "gap-3", "rounded-2xl", "border", "border-red-200", "bg-red-50", "px-4", "py-3", "text-sm", "text-red-600"], ["aria-busy", "true", 1, "grid", "gap-6", "sm:grid-cols-2", "lg:grid-cols-3", "xl:grid-cols-4"], [1, "grid", "gap-6", "sm:grid-cols-2", "lg:grid-cols-3", "xl:grid-cols-4"], [1, "mt-8", "flex", "flex-wrap", "items-center", "justify-between", "gap-3", "border-t", "border-slate-100", "pt-5", "dark:border-slate-800"], ["type", "button", 1, "rounded-full", "border", "border-red-300", "px-4", "py-1.5", "font-semibold", "hover:bg-red-100", 3, "click"], [1, "overflow-hidden", "rounded-2xl", "border", "border-slate-200", "bg-white", "shadow-sm"], [1, "aspect-[4/3]", "animate-pulse", "bg-slate-200"], [1, "space-y-3", "p-4"], [1, "h-4", "w-1/3", "animate-pulse", "rounded-full", "bg-slate-200"], [1, "h-5", "w-2/3", "animate-pulse", "rounded-full", "bg-slate-200"], [1, "h-4", "w-full", "animate-pulse", "rounded-full", "bg-slate-200"], [1, "group", "flex", "overflow-hidden", "rounded-2xl", "border", "border-slate-200", "bg-white", "shadow-sm", "transition", "duration-300", "hover:-translate-y-1", "hover:border-primary/40", "hover:shadow-lg", "dark:border-slate-800", 3, "routerLink"], [1, "col-span-full", "rounded-2xl", "border", "border-dashed", "border-slate-300", "p-12", "text-center", "text-slate-500", "dark:border-slate-700"], [1, "flex", "w-full", "flex-col"], [1, "relative", "overflow-hidden"], ["loading", "lazy", 1, "aspect-[4/3]", "w-full", "object-cover", "transition", "duration-500", "group-hover:scale-105", 3, "src", "alt"], [1, "absolute", "start-3", "top-3", "rounded-full", "bg-white/90", "px-3", "py-1", "text-xs", "font-semibold", "text-slate-700", "shadow-sm", "backdrop-blur", "/90"], [1, "flex", "flex-1", "flex-col", "p-4"], [1, "line-clamp-2", "text-lg", "font-semibold", "transition", "group-hover:text-primary"], [1, "mt-2", "line-clamp-2", "text-sm", "leading-6", "text-slate-500"], [1, "mt-auto", "pt-4"], [1, "mb-3", "flex", "items-center", "gap-2", "text-sm", "text-slate-500"], [1, "flex", "items-center", "justify-between", "gap-3", "border-t", "border-slate-100", "pt-3", "dark:border-slate-800"], [1, "text-lg", "text-primary"], [1, "text-sm", "font-semibold", "text-slate-500", "transition", "group-hover:text-primary"], [1, "mdi", "mdi-arrow-right", "rtl:rotate-180"], [1, "mdi", "mdi-map-marker-outline", "me-1", "text-primary"], [1, "mdi", "mdi-calendar-range", "text-primary"], [1, "mdi", "mdi-compass-off-outline", "text-5xl", "text-slate-300"], [1, "mt-3"], [1, "text-sm", "font-medium", "text-slate-500"], [1, "flex", "flex-wrap", "items-center", "gap-2"], [1, "flex", "items-center", "gap-2", "text-sm", "text-slate-500"], [1, "rounded-full", "border", "border-slate-200", "bg-white", "px-3", "py-2", "text-sm", "text-slate-700", "dark:border-slate-700", 3, "change", "value"], [3, "value"], [3, "pageChange", "compact", "currentPage", "totalPages"]], template: function HomeToursList_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵconditionalCreate(9, HomeToursList_Conditional_9_Template, 7, 6, "div", 6);
            i0.ɵɵconditionalCreate(10, HomeToursList_Conditional_10_Template, 3, 1, "div", 7)(11, HomeToursList_Conditional_11_Template, 4, 1, "div", 8);
            i0.ɵɵconditionalCreate(12, HomeToursList_Conditional_12_Template, 13, 11, "div", 9);
            i0.ɵɵelementEnd()();
            ...
            i0.ɵɵadvance(4);
            i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(6, 6, "tours"));
            i0.ɵɵadvance(4);
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(HomeToursList, [{
        type: Component,
        args: [{ selector: 'app-home-tours-list', standalone: true, imports: [RouterLink, TranslatePipe, HomeNavbar, FooterOne, PaginationOne], changeDetection: ChangeDetectionStrategy.OnPush, template: "<app-home-navbar />\n\n<section class=\"relative table w-full bg-cover bg-center bg-no-repeat py-36\" [style.background-image]=\"'url(' + heroImage + ')'\">\n  <div class=\"absolute inset-0 bg-gradient-to-b from-slate-900/55 via-slate-900/75 to-slate-900\"></div>\n  <div class=\"container relative pt-10 text-center\">\n    <h1 class=\"text-4xl font-semibold tracking-wide text-white\">{{ 'tours' | translate }}</h1>\n  </div>\n</section>\n\n<main class=\"relative py-16 md:py-24\">\n  <div class=\"container relative\">\n    @if (errorMessage) {\n      <div class=\"mb-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-600\">\n        <span>{{ errorMessage | translate }}</span>\n        <button type=\"button\" class=\"rounded-full border border-red-300 px-4 py-1.5 font-semibold hover:bg-red-100\" (click)=\"loadTours()\">{{ 'showMore' | translate }}</button>\n      </div>\n    }\n\n    @if (isLoading) {\n      <div class=\"grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4\" aria-busy=\"true\">\n        @for (card of [1,2,3,4,5,6,7,8]; track card) {\n          <div class=\"overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm\">\n            <div class=\"aspect-[4/3] animate-pulse bg-slate-200\"></div>\n            <div class=\"space-y-3 p-4\"><div class=\"h-4 w-1/3 animate-pulse rounded-full bg-slate-200\"></div><div class=\"h-5 w-2/3 animate-pulse rounded-full bg-slate-200\"></div><div class=\"h-4 w-full animate-pulse rounded-full bg-slate-200\"></div></div>\n          </div>\n        }\n      </div>\n    } @else {\n      <div class=\"grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4\">\n        @for (tour of tours; track tour.id ?? tour.tourId ?? $index) {\n          <a [routerLink]=\"['/tours', tour.id ?? tour.tourId]\" class=\"group flex overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-lg dark:border-slate-800 \">\n            <article class=\"flex w-full flex-col\">\n              <div class=\"relative overflow-hidden\">\n                <img [src]=\"imageUrl(tour)\" [alt]=\"tourTitle(tour)\" loading=\"lazy\" class=\"aspect-[4/3] w-full object-cover transition duration-500 group-hover:scale-105\" />\n                @if (destinationName(tour)) {\n                  <span class=\"absolute start-3 top-3 rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-slate-700 shadow-sm backdrop-blur /90 \"><i class=\"mdi mdi-map-marker-outline me-1 text-primary\"></i>{{ destinationName(tour) }}</span>\n                }\n              </div>\n              <div class=\"flex flex-1 flex-col p-4\">\n                <h2 class=\"line-clamp-2 text-lg font-semibold transition group-hover:text-primary\">{{ tourTitle(tour) }}</h2>\n                @if (tour.subDescription ?? tour.description) { <p class=\"mt-2 line-clamp-2 text-sm leading-6 text-slate-500\">{{ tour.subDescription ?? tour.description }}</p> }\n                <div class=\"mt-auto pt-4\">\n                  @if (durationDays(tour); as duration) { <p class=\"mb-3 flex items-center gap-2 text-sm text-slate-500\"><i class=\"mdi mdi-calendar-range text-primary\"></i>{{ duration }} {{ 'days' | translate }}</p> }\n                  <div class=\"flex items-center justify-between gap-3 border-t border-slate-100 pt-3 dark:border-slate-800\">\n                    <strong class=\"text-lg text-primary\">{{ formattedPrice(tour) }}</strong>\n                    <span class=\"text-sm font-semibold text-slate-500 transition group-hover:text-primary\">{{ 'exploreNow' | translate }} <i class=\"mdi mdi-arrow-right rtl:rotate-180\"></i></span>\n                  </div>\n                </div>\n              </div>\n            </article>\n          </a>\n        } @empty {\n          <div class=\"col-span-full rounded-2xl border border-dashed border-slate-300 p-12 text-center text-slate-500 dark:border-slate-700\"><i class=\"mdi mdi-compass-off-outline text-5xl text-slate-300\"></i><p class=\"mt-3\">{{ 'noToursFound' | translate }}</p></div>\n        }\n      </div>\n    }\n\n    @if (!isLoading && !errorMessage) {\n      <div class=\"mt-8 flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 pt-5 dark:border-slate-800\">\n        <span class=\"text-sm font-medium text-slate-500\">{{ 'totalRecords' | translate }}: {{ paginationInfo.totalCount }}</span>\n        <div class=\"flex flex-wrap items-center gap-2\">\n          <label class=\"flex items-center gap-2 text-sm text-slate-500\"><span>{{ 'pageSize' | translate }}</span><select class=\"rounded-full border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 dark:border-slate-700  \" [value]=\"paginationInfo.pageSize\" (change)=\"onPageSizeChange($event)\">@for (size of pageSizeOptions; track size) { <option [value]=\"size\">{{ size }}</option> }</select></label>\n          <app-pagination-one [compact]=\"true\" [currentPage]=\"paginationInfo.page\" [totalPages]=\"paginationInfo.totalPages\" (pageChange)=\"onPageChange($event)\" />\n        </div>\n      </div>\n    }\n  </div>\n</main>\n\n<app-footer-one />\n" }]
    }], null, null); })();
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(HomeToursList, { className: "HomeToursList", filePath: "app/features/home/tours-list/tours-list.ts", lineNumber: 35 }); })();
