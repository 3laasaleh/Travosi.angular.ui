...
namespace TravelAgency.InfraStructure.Migrations
{
    ...
    [Migration("20260813163916_AddNewsletterSubscriptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.BlogImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasIndex("UserId", "PackageId", "DateFrom", "DateTo")
                        .IsUnique()
                        .HasFilter("[PackageId] IS NOT NULL");

                    b.HasIndex("UserId", "TourId", "DateFrom", "DateTo")
                        .IsUnique()
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.InvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.NewsletterSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WelcomeEmailAttemptCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<DateTime?>("WelcomeEmailLastAttemptAtUtc")
                        .HasPrecision(0)
                        .HasColumnType("datetime2(0)");
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.Voucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.BlogImage", b =>
                {
                    b.HasOne("TravelAgency.Domain.Entities.Blog", "Blog")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.InvoiceItem", b =>
                {
                    b.HasOne("TravelAgency.Domain.Entities.Invoice", "Invoice")
                        .WithMany("Items")
