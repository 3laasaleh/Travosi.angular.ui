...
function sourceCode(sourceCurrency: unknown): string {
...
export function apiPrice(value: unknown, sourceCurrency: unknown = 'USD'): number {
...
export function apiCurrencyLabel(currencyId: unknown = 2): string {
