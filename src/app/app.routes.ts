...
export const routes: Routes = [
  ...
  { path: 'index-five', loadComponent: () => import('./pages/index/index-five/index-five').then(m => m.IndexFive) },
  { path: 'grid', loadComponent: () => import('./pages/innerpages/listing/tour-grid/grid-page/grid-page').then(m => m.GridPage) },
  { path: 'grid-right-sidebar', loadComponent: () => import('./pages/innerpages/listing/tour-grid/grid-right-sidebar/grid-right-sidebar').then(m => m.GridRightSidebar) },
  { path: 'grid-left-sidebar', loadComponent: () => import('./pages/innerpages/listing/tour-grid/grid-left-sidebar/grid-left-sidebar').then(m => m.GridLeftSidebar) },
  { path: 'list', loadComponent: () => import('./pages/innerpages/listing/tour-list/list-page/list-page').then(m => m.ListPage) },
  { path: 'list-left-sidebar', loadComponent: () => import('./pages/innerpages/listing/tour-list/list-left-sidebar/list-left-sidebar').then(m => m.ListLeftSidebar) },
  { path: 'list-right-sidebar', loadComponent: () => import('./pages/innerpages/listing/tour-list/list-right-sidebar/list-right-sidebar').then(m => m.ListRightSidebar) },
  ...
  { path: 'comingsoon', loadComponent: () => import('./pages/innerpages/special-pages/comingsoon-page/comingsoon-page').then(m => m.ComingsoonPage) },
  { path: 'maintenance', loadComponent: () => import('./pages/innerpages/special-pages/maintenance-page/maintenance-page').then(m => m.MaintenancePage) },
